...
JetpackWannabe.Game.prototype = {
		...
		if(!this.previousCoinType || this.previousCoinType < 3) {
		  ...
		  switch(coinType) {
		    ...
		    case 3:
		      ...
		      this.createCoinGroup(this.game.rnd.integerInRange(2,10), 2);
		      break;
		    case 4:
		      //create a large coin group
		      this.createCoinGroup(this.game.rnd.integerInRange(3,10), this.game.rnd.integerInRange(2,4));
		      break;
		    default:
	...
	coinHit: function(player, coin) {
		...
		var scoreTween = this.game.add.tween(dummyCoin).to({x: 170, y: 50}, 300, Phaser.Easing.Linear.NONE, true);
	...
	enemyHit: function(player, enemy) {
		...
		dummyPlayer.animations.play('fly', 16, true);
